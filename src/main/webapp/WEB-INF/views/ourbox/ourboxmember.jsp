<%@page import="kr.or.ddit.common.vo.RoomVO"%>
...
<body>
   ...
   <nav>
    	<div id="navLeft">
    		<a href="/ourbox/view/ourbox/ourboxmember.jsp"><img alt="ourbox.png" src="/images/ourbox_logo.png"></a>
    	...
    	<div id="navRight">
    		<a id="alarmModal" memId="${S_MEMBER.mem_id}" data-toggle="modal" data-target="#myModal"><img alt="알림이모티콘.png" src="/images/알림이모티콘.png"></a>
    		
    		<a href="/ourbox/MemoListController?memId=${S_MEMBER.mem_id}" 
    			onclick="window.open(this.href, '_blank', 'width=330px,height=420px'); return false;">
			<img alt="퀵메모메뉴버튼.png" src="/images/퀵메모메뉴버튼.png"></a>
    		
    		<a href="#" ><img alt="setting.png" src="/images/setting.png"></a>
...
<%-- 			<iframe src ="/ourbox/MemProfileController?memId=${S_MEMBER.mem_id}" name="profile" id="profile"></iframe> --%>
	...
	<div class='fdiv'>
		...
		<img id='footerimg' alt="ourbox.png" src="/images/ourbox_logo.png">
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title"><img alt="알람아이콘" src="/images/알림이모티콘.png"> ALARM</h4>
        </div>
        ...
        <div class="modal-footer">
          <button id="alarmAllDelete" type="button" class="btn btn-default" memId="${S_MEMBER.mem_id}">전체지우기</button>
