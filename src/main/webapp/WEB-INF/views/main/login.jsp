...
<div id="sum">
	<section id="left">
		...
		<div id="div1">
			...
			<img id="img1" src="/images/ourbox_main2.PNG">
		...
		<div id="box">
			<form id="login"  action="<%=request.getContextPath()%>/login/process" method ="post">
				...
				<section id = "inputleft" style="width: 60%">
					...
					<label><input class="input" type="text" name="mem_id" id="id" value="joje@ourbox.com"></label><br>
					<label for = "pass">비밀번호</label>
					<label><input class="input" type="password" name="mem_pass" id="pass" value="ourbox"></label><br>
				</section>
			...
			<div class="modal-content" style="height:480px; ">
			    	<div class="modal-header">
			        	<button type="button" class="close" data-dismiss="modal">&times;</button>
							<span class="modal-title2"><img class='simg' alt="수정시비번확인아이콘.png" src="/images/수정시비번확인아이콘.png">아이디 찾기</span>
					</div>
				...
				<hr>
				<h4 class="modal-title2" style="margin: 10px;"><img class='simg' alt="수정시비번확인아이콘.png" src="/images/수정시비번확인아이콘.png">비밀번호 찾기</h4>
				<hr>
