<%@page import="kr.or.ddit.common.vo.PlanVO"%>
...
<div class="in">
<form id = "freebox" action="<%=request.getContextPath()%>/PlanInsertServlet" method="get">
	<div class = "box" >
			<div id="free">
...
<form id = "deleteplan" action="" method="get">
	<div class = "box" seq="<%= list.get(i).getPlan_seq() %>">
		...
		<br>
		<button class="btn btn-default"><a href="<%=request.getContextPath()%>/PlanDeleteServlet?planseq=<%=list.get(i).getPlan_seq()%>">삭제</a>
</div>
</form>
